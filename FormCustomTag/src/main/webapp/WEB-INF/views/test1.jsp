...
<body>
	...
	<form action="result" method="post">
		...
		주소1 : <input type='text' name='user_adderess1' value="${requestScope.userDataBean.user_address1 }"><br/>
		주소2 : <input type='text' name='user_adderess2' value="${requestScope.userDataBean.user_address2 }"><br/>
